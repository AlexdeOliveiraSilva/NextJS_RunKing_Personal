            ...
            <form onSubmit={handleSubmit} className="form">
              ...
              <div className="boxConsent">
                <span className="consentText">
                  ...
                  pessoais, incluindo informações de saúde, exclusivamente para
                  fins médicos e de segurança durante o evento.Esses dados serão
                  tratados com sigilo, conforme a Lei Geral de Proteção de Dados
                  (Lei nº 13.709/2018), e não serão compartilhados com terceiros
                  sem meu consentimento.Os dados serão armazenados de forma
                  segura e utilizados apenas enquanto forem necessários para o
                  evento.
                </span>
