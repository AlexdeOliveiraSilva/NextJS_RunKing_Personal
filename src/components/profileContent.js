    ...
    return (
        ...
        <div className="profileContent">
            <div style={{ width: "100%", display: "flex", justifyContent: "flex-end", alignItems: "center" }}>
                ...
                <p style={{ margin: "0 30px 0 10px" }}>Olá {name}, você está convidado a fazer seu credenciamento por reconhecimento facial. Por favor, confirme seus dados e tire uma foto do seu rosto para que possamos validar seu acesso.</p>
